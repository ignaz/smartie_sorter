...
BOOTLOADER_FLAGS = -d $(BOOTLOADER_DEVICE) -b $(BOOTLOADER_BAUD)
BOOTLOADER_WRITE_FLASH = -p $(TARGET).hex
...
#flash (bootloader from peda)
flash: $(TARGET).hex $(TARGET).eep
	$(BOOTLOADER) $(BOOTLOADER_FLAGS) $(BOOTLOADER_WRITE_FLASH)
